...
const [breadName, setbreadName] = useState('Dashboard')
    ...
    <div>
      ...
      <Row>
        ...
        <Breadcrumb className="adminBread">
          ...
          <Breadcrumb.Item href={breadName==='Dashboard'?'/Dashboard':'/EmployeeBatch'}>{breadName}</Breadcrumb.Item>
