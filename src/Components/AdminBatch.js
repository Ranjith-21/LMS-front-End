...
function AdminBatch({ mentorName }) {
  ...
  const [mentor, setmentor] = useState(mentorName);
                  ...
                  {val.technologies.map((val, ind) => {
                    return (
                      <Chip
                        ...
                        label={val.label}
                        style={{ backgroundColor: "#086288", color: "white" }}
                      />
                    );
                  })}
                </td>
